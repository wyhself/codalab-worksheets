...
class BundleCLI(object):
    ...
    @Commands.command(
        ...
        help=[
            ...
            '  search name=<value>                    : Name is <value>, where `name` can be any metadata field '
            '(e.g., description).',
            '  search type=<type>                     : Bundle type is <type> (`run` or `dataset`).',
            '  search id=<id>                         : Has <id> (integer used for sorting, '
            ...
            '',
            '  search .before=<datetime>              : Returns bundles created before (inclusive) given ISO 8601 '
            'timestamp (e.g., .before=2042-3-14).',
            '  search .after=<datetime>               : Returns bundles created after (inclusive) given ISO 8601 '
            'timestamp (e.g., .after=2120-10-15T00:00:00-08).',
            '',
            '  search size=.sort                      : Sort by a particular field '
            '(where `size` can be any metadata field).',
